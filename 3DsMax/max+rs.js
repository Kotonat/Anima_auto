        ...
        */
        ...
        // Выбор рендерера Redshift
                cy.get('#app > div.flex.flex-col.account-wrapper > div.flex.flex-row.account-content > div.content.start-render > div > div.software-selector > div:nth-child(3) > div.relative.v-input-box > div > div.multiselect__tags').click();
                    cy.get('#app > div.flex.flex-col.account-wrapper > div.flex.flex-row.account-content > div.content.start-render > div > div.software-selector > div:nth-child(3) > div.relative.v-input-box > div > div.multiselect__content-wrapper > ul > li:nth-child(3)').click(); //выбор Octane
        	// Выбор версии
